...
public class CameraSource {
    ...
    public static class Builder {
        ...
        public CameraSource build() {
            mCameraSource.mFrameProcessor = mCameraSource.new FrameProcessingRunnable(mBarcodeScanner);
    ...
    private byte[] createPreviewBuffer(Size previewSize) {
        long bitsPerPixel = ImageFormat.getBitsPerPixel(ImageFormat.NV21);
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        FrameProcessingRunnable(BarcodeScanner barcodeScanner) {
        ...
        public void run() {
            while (true) {
                ...
                try {
                    ...
                    Log.e(TAG, "Exception in frame processing", e);
                }
            }
        }
    }
