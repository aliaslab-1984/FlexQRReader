...
package net.aliaslab.securecall.flexqrreader.zxing.android.result;
...
import net.aliaslab.securecall.flexqrreader.zxing.android.Contents;
import net.aliaslab.securecall.flexqrreader.zxing.android.Intents;
import net.aliaslab.securecall.flexqrreader.zxing.result.ParsedResult;
import net.aliaslab.securecall.flexqrreader.zxing.result.ParsedResultType;
import net.aliaslab.securecall.flexqrreader.zxing.result.ResultParser;
...
public abstract class ResultHandler {
  ...
  private void sendMMSFromUri(String uri, String subject, String body) {
    ...
    if (subject == null || subject.isEmpty()) {
      putExtra(intent, "subject", /*activity.getString(R.string.msg_default_mms_subject)*/ "Hi");
    } else {
